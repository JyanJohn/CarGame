# Source code by : Rhandhir
# Rewritten and modified by : JyanJohn
# Date : 10-19-21/07:14PM
...
class CarGame:
    ...
    def game_window(self):
        ...
        pygame.display.set_caption('Car Game -- JyanJohn')
        self.run_car()
    ...
    def display_credit(self):
        ...
        text = font.render("Randhir Kumar and JyanJohn", True, self.white)
        self.gameDisplay.blit(text, (600, 540))
        text = font.render("https://jyanjohn.github.io/Jyandevs.github.io/index.html", True, self.white)
